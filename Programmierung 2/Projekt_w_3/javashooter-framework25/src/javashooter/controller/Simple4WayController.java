 ...
 */ 
  public int  computeRequestedState() {
    ...
    for (int i = 0; i < pe.length; i ++) {
      String pressed_name = pe[i] + "_pressed" ;
      String released_name = pe[i] + "_released" ;
      if ((this.heading != i) && (pg().getFlagAsString(pressed_name, false, "false")).equals("true"))  {
        //System.out.println("key"+i) ;
        return i ;
      }
      if ((this.heading == i) && (pg().getFlagAsString(released_name, false,"false")).equals("true")) {
        return getStopCode() ;
      }
